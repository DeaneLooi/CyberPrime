...
define(
		"dijit/ProgressBar",
		[ "require", "dojo/_base/declare", "dojo/dom-class", "dojo/_base/lang",
				"dojo/number", "./_Widget", "./_TemplatedMixin",
			...
			return _2(
					...
					[ _6, _7 ],
					{
						...
						_setDirAttr : function(_9) {
							_3.toggle(this.domNode, "dijitProgressBarRtl",
									_9 == "rtl");
							this.inherited(arguments);
						},
						update : function(_a) {
